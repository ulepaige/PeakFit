...
def calculate_shape_amplitudes(params, x_list, y_list, data, n_peaks, amplitude_params=False):
    shapes = []
...
def residuals(params, x_list, y_list, data, n_peaks, noise=1.0, amplitude_params=False):
    shapes, amplitudes = calculate_shape_amplitudes(params, x_list, y_list, data, n_peaks,
                                                    amplitude_params)
